...
<div class="col-sm-12">
    <ul class="nav nav-tabs nav-tabs-bottom" id="setting_tab" role="tablist">
        <li class="nav-item"><a class="nav-link active" href="#manage_tab" data-toggle="tab"><i class="fas fa-th-list"></i><span class="margin_right_5">مدیریت آیتم ها ها</span></a></li>
